...
/**
 * Converts the Confluence layout container by parsing and outputting its converted content.
 *
 * @version $Id$
 */
@Component
@Singleton
@Named("layout")
public class LayoutMacroConverter extends AbstractParseContentMacroConverter
{
    @Override
