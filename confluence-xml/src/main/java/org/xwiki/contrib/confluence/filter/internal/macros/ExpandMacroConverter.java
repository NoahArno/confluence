...
/**
 * Convert Confluence expand macro to XWiki expandable macro.
 *
 * @version $Id$
 * @since 9.96.0
 */
...
@Singleton
@Named("expand")
public class ExpandMacroConverter extends AbstractMacroConverter
{
    @Override
        ...
        String content)
    {
        ...
        saveParameter(confluenceParameters, parameters, "title", "summary", true);
        return parameters;
    }
